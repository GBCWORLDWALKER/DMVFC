...
if __name__ == "__main__":
    ...
    parser.add_argument('--presaved_path', default=None, type=str, help='path of pre-saved results')
    ...
    parser.add_argument('--data_parallel',default=None,type=str2bool,help='data parallel or not')
    parser.add_argument('--model_b',default=None,type=str2bool,help='model b or not')
    parser.add_argument('--trained_net_mapping',default=None,type=str,help='trained net mapping')
    parser.add_argument('--mapping',default=None,type=str2bool,help='mapping or not')
    parser.add_argument('--none_mapping',default=None,type=str2bool,help='none mapping or not')
