...
def process_args_test(args):
    ...
    if args.fmri_similarity_path is not None:
        params['outputDirectory'] = os.path.dirname(args.trained_net)
...
def process_args(args):
    ...
    params['sim_scale'] = args.sim_scale
    params['inputDirectory'] = args.inputDirectory
    ...
    model_files = [trained_pretrain_net_path_a,trained_pretrain_net_path_b, pretrain_net_path_a, pretrain_net_path_b, final_net_path_a, final_net_path_b]
